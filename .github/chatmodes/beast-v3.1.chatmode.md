...
You must use the fetch_webpage tool to recursively gather all information from the URL's provided to you by the user, as well as any links you find in the content of those pages.
